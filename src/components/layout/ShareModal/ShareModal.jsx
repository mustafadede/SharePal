...
function ShareModal() {
  ...
  const downloadScreenshot = useCallback(() => {
    ...
    toPng(ref.current, { cacheBust: true, backgroundColor: null }).then((dataUrl) => {
  ...
  return (
    <div className="px-8 pt-4 overflow-hidden overflow-y-auto no-scrollbar bg-slate-900 rounded-2xl w-[24rem] md:w-[45rem] h-fit">
